...
<br>
<br>
VEGETABLE:<input text> 
COST/kg: <input text>
<br><br><br>
<br><br><br>
<a href ="/veggies"><button style= "background-color:blue; color:white">SUBMIT</button></a>
&nbsp;&nbsp;&nbsp;&nbsp;
<a href ="/veggies"><button style= "background-color:blue; color:white">CANCEL</button></a>
