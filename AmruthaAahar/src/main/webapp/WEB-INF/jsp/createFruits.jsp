...
<br><br><br>
<br><br><br>
<a href ="/fruits"><button style= "background-color:blue; color:white">SUBMIT</button></a>
&nbsp;&nbsp;&nbsp;&nbsp;
<a href ="/fruits"><button style= "background-color:blue; color:white">CANCEL</button></a>
